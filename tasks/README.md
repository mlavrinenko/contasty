...
- [ ] 05 — User-extensible & overridable rule sets (`05-custom-rules.md`)
...
PHP as YAML only. 04 is the extensibility path for unbundled grammars. 05 lets
users extend or override a language's standard rules from config.
